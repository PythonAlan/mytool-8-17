...
def air(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            first_class_cost_wini_sea_au = round(float(Sea_fee(volume,secondprice.sea['au_fee'])),1)
            second_class_wini_au = second_class_wini_au
            commission_cost_au = round(Commission_Cost(price,commission_rate,exchange_rate_au),1)
            total_cost_wini_au = round(float(Total_Cost(float(First_Class_Cost(weight,first_class_rate_au)),
                                            second_class_wini_au*exchange_rate_au,
            ...
            total_cost_wini_sea_au = round(float(Total_Cost(first_class_cost_wini_sea_au,
                                            second_class_wini_au*exchange_rate_au,
                                            purchase_price,
                                            commission_cost_au,
                                             )),1)
            ...
            no_commission_cost_wini_sea_au = No_Commission_Cost(total_cost_wini_sea_au,commission_cost_au)
            gross_profit_wini_sea_au = round(Gross_Profit(price,total_cost_wini_sea_au,exchange_rate_au),1)
            profit_margins_wini_sea_au = round(Profit_margins(gross_profit_wini_sea_au,price,exchange_rate_au),1)
            zero_sale_price_wini_sea_au = round(no_commission_cost_wini_sea_au/exchange_rate_au/0.82,1)
            five_sale_price_wini_sea_au = round(no_commission_cost_wini_sea_au/0.77/exchange_rate_au,1)
            ten_sale_price_wini_sea_au = round(no_commission_cost_wini_sea_au/0.72/exchange_rate_au,1)
            fifteen_sale_price_wini_sea_au = round(no_commission_cost_wini_sea_au/0.67/exchange_rate_au,1)
            twenty_sale_price_wini_sea_au = round(no_commission_cost_wini_sea_au/0.62/exchange_rate_au,1)
            twentyfive_sale_price_wini_sea_au = round(no_commission_cost_wini_sea_au/0.57/exchange_rate_au,1)
            thirty_sale_price_wini_sea_au = round(no_commission_cost_wini_sea_au/0.52/exchange_rate_au,1)
            ...
            result_list= {
                ...
                'total_cost_wini_sea_au':total_cost_wini_sea_au,
                'first_class_cost_wini_sea_au':  first_class_cost_wini_sea_au,
                'gross_profit_wini_sea_au': gross_profit_wini_sea_au,
                'profit_margins_wini_sea_au':profit_margins_wini_sea_au,
                'zero_sale_price_wini_sea_au' :zero_sale_price_wini_sea_au,
                'five_sale_price_wini_sea_au':five_sale_price_wini_sea_au,
                'ten_sale_price_wini_sea_au':ten_sale_price_wini_sea_au,
                'fifteen_sale_price_wini_sea_au':fifteen_sale_price_wini_sea_au,
                'twenty_sale_price_wini_sea_au':twenty_sale_price_wini_sea_au,
                'twentyfive_sale_price_wini_sea_au':twentyfive_sale_price_wini_sea_au,
                'thirty_sale_price_wini_sea_au':thirty_sale_price_wini_sea_au,
